...
return [
    ...
    */
    ...
    'project_name' => 'Geomodule',

    // Menu logos
    'logo_lg'   => '<b>Geo</b>module',
    'logo_mini' => '<b>G</b>eo',

    // Developer or company name. Shown in footer. Dervlas
    'developer_name' => false,

    // Developer website. Link in footer. http://dervlas.host
    ...
    'overlays' => [
    //    'vendor/backpack/base/backpack.bold.css', Сменв шрифтов в меню админа
